...
void reset_locks(void)
{
    if (g_lock_reg) {
        ...
        g_lock_reg->scan_A               =      0;
        g_lock_reg->scan_B               =      0;
        g_lock_reg->scan_step            =      0;
        g_lock_reg->scan_low_lim         =  -5000;
        g_lock_reg->scan_hig_lim         =   5000;
        g_lock_reg->scan_reset           =      0;
        g_lock_reg->scan_enable          =      0;
        g_lock_reg->scan_direction       =      0;
        g_lock_reg->scan_B_factor        =   4096;
